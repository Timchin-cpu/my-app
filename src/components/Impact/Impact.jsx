  ...
  return (
    <section className={styles.section}>
      <div className={styles.container}>
        <h1 className={styles.title}>The science behind BreatheSafetyIndex</h1>
        <div className={styles.textImageWrapper}>
          {" "}
          <div className={styles.aboutSection}>
            <p className={styles.aboutText}>
              Leveraging research from leading institutions and backed by a team
              of experts in public health, environmental science, and data
              analytics, BreatheSafetyIndex assesses disease risks with
              unparalleled accuracy. Our model evaluates the effect of air
              quality on seven key health systems, offering unique insights into
              the environmental factors impacting human health.
            </p>
        ...
        <div className={styles.modal}>
          <div className={styles.modalContent}>
            <div className={styles.aboutTextMore}>
              <p>
                BreatheSafetyIndex employs a sophisticated risk evaluation model
                that analyzes pollution’s impact on seven critical health
                systems, including respiratory, cardiovascular, immune, and
                nervous systems. The methodology encompasses dynamic data
                processing, which integrates:
              </p>
              <ul>
                <li>
                  Air Quality and Environmental parameters: Using data on
                  particulate matter (PM2.5 - 5.0), NOx, SOx, temperature,
                  humidity, insolation etc, our system provides a comprehensive
                  evaluation of environmental impacts.
                </li>
                <li>
                  Risk calculation models: Our method calculates health risk
                  levels by assessing the frequency increase of adverse events
                  (e.g., cardiovascular conditions) against nominally “safe”
                  thresholds established by the World Health Organization. This
                  model uses a unique set of functions that considers the
                  default baseline risk and adjusts it based on pollutant
                  concentrations, reflecting the cumulative impact of poor air
                  quality on specific bodily systems.
                </li>
              </ul>
            </div>
