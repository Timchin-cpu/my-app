  ...
  return (
    <section className={styles.section}>
      <div className={styles.container}>
        <h1 className={styles.title}>BreatheSafetyIndex`s key offerings:</h1>
            ...
            <div className={styles.aboutText}>
              <ul>
                <li>
                  ...
                  capabilities to provide high-resolution hourly pollutant data.
                </li>
                <li>
                  Comprehensive outdoor environment hazards assessmentsOur
                  system evaluates risk levels for respiratory, cardiovascular,
                  immune, and other systems based on live air quality data,
                  giving an all-encompassing view of pollution’s impact on
                  health.
                </li>
                <li>
                  Simple API integrationEasily integrate our JSON-based API into
                  your weather services, smart city platforms, health apps, or
                  public health management systems. The user-friendly format
                  ensures seamless access to our extensive data, helping you
                  deliver reliable, real-time information on air quality risks
                  to your users.
                </li>
              </ul>
            </div>
